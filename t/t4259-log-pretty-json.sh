...
printf '{commits: [{"summary": "sixth"},{"summary": "fifth"},{"summary": "fourth"},{"summary": "third"},' > expect
printf '{"summary": "second"},{"summary": "initial"}]}' >> expect
test_expect_success 'pretty' '

	git log --pretty="json:%s" > actual &&
